...
const DashDefault = () => {
  ...
  const fetch = async (req, res) => {
    try {
      ...
      const dashdata = await axios.get('/api/dashdata', {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
      setDash(dashdata.data);
      console.log(dashdata.data.staffData);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <React.Fragment>
      <Row>
        <Col key={1} xl={6} xxl={4}>
          <Card>
            <Card.Body>
              <h6 className="mb-4">Total Cards</h6>
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
                    <i className={`feather icon-arrow-up text-c-green f-30 m-r-5`} />5
                  </h3>
                </div>
          ...
          <Card>
            <Card.Body>
              ...
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
                    <i className={`feather icon-arrow-up text-c-green f-30 m-r-5`} />45
                  </h3>
                </div>
                <div className="col-3 text-end">
                  <p className="m-b-0">100%</p>
        ...
        <Col key={3} xl={6} xxl={4}>
          <Card>
            <Card.Body>
              <h6 className="mb-4">Total Staff</h6>
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
                    <i className={`feather icon-arrow-up text-c-green f-30 m-r-5`} /> 45
