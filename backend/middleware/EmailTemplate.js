...
export const Remainder_Email_Template = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          <div class="header">Payment Remainder</div>
          <div class="content">
            <p>Hello,</p>
            <p>This is a friendly reminder that your payment of <strong>{amnt}</strong> is due on <strong>${today}</strong>.</p>
            <p>Please make the payment at your earliest convenience to avoid any late fees.</p>
            <p>You can complete the payment using the link below:</p>
            <p><a href="[Payment Link]" class="button">Make Payment</a></p>
            <p>If you've already paid, please ignore this message.</p>
          </div>

          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Inventory Management. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
